    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_menuItemSaveImage = new wxMenuItem(m_menuFile, wxID_ANY, wxT("Save chart as image"), wxT(""), wxITEM_NORMAL);
    m_menuFile->Append(m_menuItemSaveImage);
    
    m_menuItemSendToClipboard = new wxMenuItem(m_menuFile, wxID_ANY, wxT("Send to clipboard"), wxT(""), wxITEM_NORMAL);
    ...
    m_pgMgrArr.Clear();
    m_pgMgrIntArr.Clear();
    m_pgProplineType = m_pgMgr->AppendIn( m_pgPropLineProp,  new wxEnumProperty( wxT("Type"), wxPG_LABEL, m_pgMgrArr, m_pgMgrIntArr, 0) );
    ...
    m_pgProplineAxis = m_pgMgr->AppendIn( m_pgPropLineProp,  new wxEnumProperty( wxT("Axis"), wxPG_LABEL, m_pgMgrArr, m_pgMgrIntArr, 0) );
    ...
    m_pgPropChartTitle = m_pgMgr->AppendIn( m_pgPropChartProp,  new wxStringProperty( wxT("Chart title"), wxPG_LABEL, wxT("")) );
    m_pgPropChartTitle->SetHelpString(wxT(""));
    m_pgPropChartTitle->SetEditor( wxT("TextCtrl") );
    
    m_pgPropXLabel = m_pgMgr->AppendIn( m_pgPropChartProp,  new wxStringProperty( wxT("X axis label"), wxPG_LABEL, wxT("")) );
    m_pgPropXLabel->SetHelpString(wxT(""));
    m_pgPropXLabel->SetEditor( wxT("TextCtrl") );
    
    m_pgPropYLabel = m_pgMgr->AppendIn( m_pgPropChartProp,  new wxStringProperty( wxT("Y axis label"), wxPG_LABEL, wxT("")) );
    ...
    m_pgPropAxisLimit = m_pgMgr->AppendIn( m_pgPropChartProp,  new wxStringProperty( wxT("Axis limit"), wxPG_LABEL, wxT("")) );
